...
class UiTheme {
  ...
  ThemeData builder(ThemeData themeData, BuildContext context, {String? fontFamily}) {
    ...
    return themeData.copyWith(
        ...
        colorScheme: themeData.colorScheme.copyWith(secondary: secondary, background: Colors.grey.shade100),
        ...
        appBarTheme: themeData.appBarTheme.copyWith(
            ...
            backgroundColor: myPlatform.whenOrNull(macos: () => Colors.transparent, ios: () => Colors.white, android: () => Colors.white)),
        ...
        outlinedButtonTheme: OutlinedButtonThemeData(
            style: themeData.outlinedButtonTheme.style ??
                _buildButtonStyle().copyWith(foregroundColor: const MaterialStatePropertyAll(Colors.grey), side: MaterialStatePropertyAll(BorderSide(color: Colors.grey.shade400, width: .7)))),
        ...
        bottomNavigationBarTheme: themeData.bottomNavigationBarTheme.copyWith(type: BottomNavigationBarType.fixed, backgroundColor: Colors.white, elevation: 6),
        ...
        bottomAppBarTheme: BottomAppBarTheme(elevation: 16, color: Colors.grey.shade200, shadowColor: Colors.grey, height: 48, surfaceTintColor: Colors.grey.shade200),
        navigationBarTheme: NavigationBarThemeData(backgroundColor: Colors.grey.shade200, surfaceTintColor: Colors.grey.shade100, shadowColor: Colors.grey, elevation: 10, height: 48),
  ...
  ButtonStyle _buildButtonStyle() {
    return ButtonStyle(shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(cardRadius / 2))), padding: const MaterialStatePropertyAll(EdgeInsets.all(6)));
  }
  ...
  DialogTheme _dialogTheme(Color backgroundColor, {required Color titleColor}) {
    return DialogTheme(
        elevation: 10, titleTextStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: titleColor), backgroundColor: backgroundColor, surfaceTintColor: backgroundColor.withOpacity(.9));
  }
  ...
  CardTheme _cardTheme(Color color) {
    return CardTheme(color: color, margin: const EdgeInsets.all(12), shadowColor: color, surfaceTintColor: color, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(cardRadius)));
  }

  ListTileThemeData _listTileTheme({required Color tileColor, Color? subColor}) {
    return ListTileThemeData(tileColor: tileColor, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(cardRadius)), subtitleTextStyle: TextStyle(color: subColor));
  }
  ...
  PopupMenuThemeData _buildPopupMenuTheme(Color bg) {
    return PopupMenuThemeData(
        ...
        surfaceTintColor: bg,
        elevation: 10,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(cardRadius), side: const BorderSide(width: .6, color: Colors.black26)));
  }
}
