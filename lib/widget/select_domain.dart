                    ...
                    PopupMenuButton<AddSiteType>(
                        itemBuilder: (context) {
                          return [
                            ...
                            const PopupMenuItem(
                                value: AddSiteType.importFromFile,
                                child: Text('从文件导入')),
                            const PopupMenuItem(
        ...
        return Column(
          ...
          children: [
            ...
            if (version.isNotEmpty)
              Text(version, style: context.textTheme.labelSmall)
          ],
        );
      },
    );
            ...
            child: LayoutBuilder(builder: (context, size) {
              return HoverCard(
                shape: RoundedRectangleBorder(
                    side: BorderSide(
                        width: .1, color: context.colorScheme.outline),
...
class _DomainAccountWifState extends ConsumerState<_DomainAccountWif>
        ...
        return LayoutBuilder(
          builder: (context, constraints) {
            ...
            if (logo.urlManager.withoutExtension == 'svg') {
              ...
              return ImageView(
                  image: MyImage.network(url: logo, params: imageParam));
            }
          },
        );
      },
      ...
      content: SpaceColumn(
        ...
        children: [
          TextField(
            ...
            decoration: const InputDecoration(hintText: "输入远程json链接"),
          ),
          FilledButton(
                  onPressed:
